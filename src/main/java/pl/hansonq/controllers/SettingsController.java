...
public class SettingsController implements Initializable {
    ...
    @FXML
    private TextField textLogin,textDatabase,textSystemDatabase;
    ...
    @FXML
    private Button buttonDatabaseChoose, buttonSave,buttonSystemDatabaseChoose;;
...
//        textFtpPath.setText(Settings.getFtpPath());
//        textFtpJsonFile.setText(Settings.getFtpJsonFile());
    ...
    private void saveSettings() {
        ...
        try {
            ...
            prop.setProperty("sqlSystemLink", "jdbc:firebirdsql:localhost/3050:" + textSystemDatabase.getText() + "?sql_dialect=3&encoding=UTF8");
             prop.setProperty("sqlLink", "jdbc:firebirdsql:localhost/3050:" + textDatabase.getText() + "?sql_dialect=3&encoding=UTF8");
            // OPCJE FTP
